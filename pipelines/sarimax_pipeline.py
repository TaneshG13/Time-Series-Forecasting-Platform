...
class SARIMAXPipeline:
    ...
    def run(
        ...
        if df.isna().sum().sum() > 0:
            ...
            raise ValueError(
                "Data contains missing values. Clean data before pipeline."
            )
        ...
        if not exog_cols:
            ...
            raise ValueError(
                "No exogenous feature columns found."
            )
